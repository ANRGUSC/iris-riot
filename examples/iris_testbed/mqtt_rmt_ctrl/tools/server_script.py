...
toggle_client = []
toggle_client_value = [True] * NUM_NODES
    ...
    while True:
        ...
        if c != -1:
            ...
            if str(c) == "97": #value of a
                ...
                if (toggle_client_value == [True] * NUM_NODES):
            ...
            elif str(c) == "50" and NUM_NODES >= 2: #use '2' on the keyboard to toggle the second node
                toggle_client_value[((int(str(c)))-49)] = not toggle_client_value[((int(str(c)))-49)]
                stdscr.addstr("toggle 2nd node")
            elif str(c) == "51" and NUM_NODES >= 3: #use '3' on the keyboard to toggle the third node
                toggle_client_value[((int(str(c)))-49)] = not toggle_client_value[((int(str(c)))-49)]
                stdscr.addstr("toggle 3rd node")
            elif str(c) == "52" and NUM_NODES >= 4: #use '4' on the keyboard to toggle the fourth node
                toggle_client_value[((int(str(c)))-49)] = not toggle_client_value[((int(str(c)))-49)]
                stdscr.addstr("toggle 4th node")    
            elif str(c) == "53" and NUM_NODES >= 5: #use '5' on the keyboard to toggle the fifth node
                toggle_client_value[((int(str(c)))-49)] = not toggle_client_value[((int(str(c)))-49)]
...
while 1:
    ...
    if (clients_connected == NUM_NODES and rmt_ctrl_start):
        time.sleep(2)
